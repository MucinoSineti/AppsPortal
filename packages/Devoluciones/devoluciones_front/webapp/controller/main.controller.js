sap.ui.define([
    ...
    return Controller.extend("devolucionesfront.controller.main", {
        onInit() {
        ...
        getOrders: function () {
            ...
            // Construir URL final
            var sUrl = "/odata/v4/ord-compra/ReadListNC";
            if (sFilter) {
                sUrl += "?$filter=" + sFilter;
            }
        ...
        getItemsOC: function (PurchaseOrder) {
            ...
            fetch("/odata/v4/ord-compra/ReadDocFlow?$filter=PurchaseOrder eq '" + PurchaseOrder + "' and IsReturnsItem eq true" , {
                method: "GET",
                headers: {
                    "Accept": "application/json"
                },
            ...
            if (!this._oDialog) {
                this._oDialog = await Fragment.load({
                    name: "devolucionesfront.fragments.MatDocLists",
                    controller: this
                });
